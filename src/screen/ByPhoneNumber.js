...
const ByPhoneNumber = ({ navigation }) => {
  return (
...
<MainButton horizontal={30} label={'Подтвердить и войти в аккаунт '} background={'#F7F7F7'} color={'#72777A'} action={() => navigation.navigate("FeedBackScreen")}/>
    </ScrollView>
  );
};
